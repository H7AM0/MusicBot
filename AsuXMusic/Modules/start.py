...
async def help(client: Abishnoi, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/d371bea7c4614d769d166.jpg",
        caption=f"""ᴀ ᴛᴇʟᴇɢʀᴀᴍ ʙᴏᴛ ғᴏʀ ᴍᴀɴᴀɢɪɴɢ ʏᴏᴜʀ ɢʀᴏᴜᴘs ɪɴ ᴀ ᴇғғɪᴄɪᴇɴᴛ ᴡᴀʏ.  ✨""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🧸", url=f"https://t.me/SOURCE_HAMO"
                    )
                ]
            ]
        ),
